/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism-solarizedlight&languages=markup+css+clike+javascript+bash+c+cpp+cmake+diff+git+http+java+json+julia+latex+lua+makefile+markdown+markup-templating+objectivec+perl+php+python+r+ruby+sas+sql+swift+vim+wiki+yaml&plugins=line-numbers+show-language+highlight-keywords+toolbar */
